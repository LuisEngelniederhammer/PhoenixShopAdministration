...
<a href="main.php" class="btn btn-lg btn-block">Back</a>
	<div class="form-group col-4 col-mx-auto">
		<form action="{{PROCESS_FORM}}" method="POST">
  			<label class="form-label" for="input-1">ID</label>
  			<input class="form-input" type="text" id="input-1" name="id" value="{{id}}" readonly>
  			
  			<label class="form-label" for="input-2">Name</label>
  			<input class="form-input" type="text" id="input-2" name="name" value="{{name}}">
  			...
  			<input class="form-input" type="text" id="input-4" name="price" value="{{price}}">
  			
  			<label class="form-label" for="input-5">Picture</label>
  			<input class="form-input" type="text" id="input-5" name="picture" value="{{picture}}">
  			
  			<label class="form-label" for="input-6">Type</label>
  			<select class="form-input" type="text" id="input-6" name="type" required>
  				<option></option>
  			...
  			<input class="form-input" type="text" id="input-7" name="donator" value="{{donator}}" >
  			...
  			<input class="form-input" type="text" id="input-9" name="requirement_value" value="{{requirement_value}}" >
  			
  			<label class="form-label" for="input-10">Buy interval</label>
  			<input class="form-input" type="text" id="input-10" name="buy_interval" value="{{buy_interval}}">
  			
  			<label class="form-label" for="input-11">Max in inv</label>
  			<input class="form-input" type="text" id="input-11" name="max_in_inv" value="{{max_in_inv}}" >
  		
  			<input class="form-input" type="submit">
  		</form>
	</div>
	<script>
		document.getElementById('input-3').value={{itemid}};
		document.getElementById('input-6').value={{type}};
		document.getElementById('input-8').value={{requirement}};
	</script>
</body>
<html>